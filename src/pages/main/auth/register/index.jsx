...
const RegisterPage = () => (
	<section className="grid md:grid-cols-2 items-center justify-center gap-6 max-w-7xl w-full">
		<div className="md:col-span-1 flex min-h-full flex-1 flex-col justify-center md:p-8 md:px-0 md:mt-2">

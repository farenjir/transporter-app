...
import { AutocompletePublic, Buttons, CalenderDateRange, Icons, InputType, Selects } from "components";

const InternationalRequest = ({ edit, info }) => {
	const { t } = useTranslation();
	const { onChangeAutocomplete, autocompleteLoading, autoData, loading, jalali, enums, priceTypes, record } =
